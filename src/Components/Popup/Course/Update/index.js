...
const UpdateCourse = (props) => {
  ...
  const handleUpdateCourse = () => {
    // Send a request to http://127.0.0.1:8000/course_list/ with the course data
    fetch('http://127.0.0.1:8000/course_list/', {
      method: 'PUT',
      headers: {
  ...
  return (
    <div style={{ backgroundColor: 'red', position: 'absolute', left: '600px', height: '350px', width: '500px', padding: '20px', display: 'flex', justifyContent: 'center', flexDirection: 'column', borderRadius: '10%' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', marginTop: '30px' }}>
        <button style={{ height: '35px', width: '30%', borderRadius: '10%' }} onClick={handleUpdateCourse}>Update</button>
